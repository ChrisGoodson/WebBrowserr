...
namespace WebBrowser.Data {
    ...
    public partial class HistoryDataSet : global::System.Data.DataSet {
        ...
        public partial class HistoryDataTable : global::System.Data.TypedTableBase<HistoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public HistoryRow AddHistoryRow(string URL, string Title) {
...
namespace WebBrowser.Data.Database1DataSet1TableAdapters {
    ...
    public partial class HistoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[History] ([URL], [Title]) VALUES (@URL, @Title);\r\nSELECT Id, U" +
                "RL, Title FROM History WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[History] SET [URL] = @URL, [Title] = @Title WHERE (([Id] = @Origina" +
                "l_Id) AND ([URL] = @Original_URL) AND ([Title] = @Original_Title));\r\nSELECT Id, " +
                "URL, Title FROM History WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, URL, Title FROM dbo.History";
